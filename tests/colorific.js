...
describe('simple color encodings', function () {
  ...
  describe('multiple, unnested color ecodings', function () {
    it('should return a string with red and blue', function () {
      ...
      expect(result).toEqual('a string with \x1b[31mred \x1b[39mand \x1b[34mblue\x1b[39m');
    });
    ...
    it('should return a string with red, green and blue', function () {
      ...
      expect(result).toEqual('a string with \x1b[31mred\x1b[39m, \x1b[32mgreen \x1b[39mand \x1b[34mblue\x1b[39m');
    });
  });
  ...
  describe('multiple, nested color ecodings', function () {
    it('should return a string with red and blue on yellow background', function () {
      ...
      expect(result).toEqual('\x1b[43ma string with \x1b[31mred \x1b[39mand \x1b[34mblue \x1b[39mon yellow background\x1b[49m');
    });
    ...
    it('should return a string with red, green and blue on yellow background', function () {
      ...
      expect(result).toEqual('\x1b[43ma string with \x1b[31mred\x1b[39m, \x1b[32mgreen \x1b[39mand \x1b[34mblue \x1b[39mon yellow background\x1b[49m');
    });
  });
});
